...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const redirect = data.user.role === 'admin' ? '/admin/dashboard' : '/user/dashboard';
  ...
  return (
    <main className="min-h-screen flex bg-[#fdf2f3] text-[#902f3c] font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#902f3c] to-[#a74455] justify-center items-center">
        ...
        >
          ...
          <p className="text-lg text-white/80">
            Login to manage your shipments and track your logistics in real-time.
          </p>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
        ...
        >
          <h2 className="text-3xl font-bold mb-2 text-[#902f3c]">Login to your account</h2>
          <p className="text-gray-600 text-sm">Access your dashboard and shipments</p>
          ...
          <p className="text-sm text-gray-500 text-center">
            ...
            <Link href="/signup" className="text-[#902f3c] font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </motion.div>
